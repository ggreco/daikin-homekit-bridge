...
impl HeaterCoolerAccessory {
    ...
    pub fn new(id: u64, information: AccessoryInformation) -> Result<Self> {
        ...
        // NOTE: upstream 0.1.0-pre.15 hard-disabled `cooling_threshold_temperature`
        // here. That leaves a Cool-capable HeaterCooler without a cool setpoint
        // characteristic, so the Home app shows "cooling to (null)" and disables
        // the temperature/fan controls. Keep it enabled (see the `ihciah` fork).
